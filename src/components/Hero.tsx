...
const codeLines = [
  ...
  {
    num: 2,
    tokens: [{ t: '@RequestMapping("/api/orders")', c: "annotation" }],
  },
  {
    num: 3,
    tokens: [
  ...
  { num: 4, tokens: [] },
  {
    num: 5,
    tokens: [
      { t: "    private final ", c: "keyword" },
      { t: "OrderService", c: "class" },
      { t: " orderService;", c: "plain" },
    ],
  },
  { num: 6, tokens: [] },
  ...
  },
  {
    ...
    tokens: [
      { t: "        return ", c: "keyword" },
      { t: "ResponseEntity", c: "class" },
      { t: ".ok(orderService.", c: "plain" },
    ],
  },
  {
    num: 11,
    tokens: [{ t: "                getOrderById(id));", c: "plain" }],
  },
...
const features = [
  {
    title: "API FIRST",
    description:
      "Progetto e sviluppo API RESTful con attenzione a usabilità e scalabilità.",
    Icon: Code2,
  },
  {
    title: "DATA DRIVEN",
    description: "Modello database relazionali e scrivo query ottimizzate.",
    Icon: Database,
  },
  {
    title: "SECURE & RELIABLE",
    description:
      "Autenticazione, autorizzazione e validazione dei dati come standard di progetto.",
    Icon: ShieldCheck,
  },
];
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "1.05rem", maxWidth: "440px" }}>
              Sviluppo API REST, modello database relazionali e costruisco
              logiche backend pensate per restare chiare e pronte ad evolvere.
            </p>
            ...
            >
              ...
              <span style={{ color: "var(--accent)", fontWeight: 600 }}>
                architetture pulite, sostenibili
              </span>{" "}
              e{" "}
              <span style={{ color: "var(--accent)", fontWeight: 600 }}>
                scalabili
            ...
            <div className="code-window">
              ...
              <div className="code-body">
                {codeLines.map((line) => (
                  <div
                    key={line.num}
                    className={`code-line${line.num === 8 ? " highlighted" : ""}`}
                  >
                    ...
                    <span>
                      {line.tokens.map((tok, i) => (
                        <span
                          key={i}
                          style={{
                            color: colorMap[tok.c] || "var(--text-secondary)",
                          }}
                        >
                          {tok.t}
                        </span>
