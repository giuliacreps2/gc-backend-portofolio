  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── SIDEBAR ── */}
        <aside
          style={{ position: "sticky", top: "calc(var(--nav-height) + 24px)" }}
        >
          <nav
        ...
        >
          ...
          >
            ...
            <p style={{ lineHeight: 1.85, whiteSpace: "pre-line" }}>
              {project.overview}
            </p>
          </div>
            ...
            >
              {project.solution.map((s, i) => (
                ...
                >
                  ...
                  <span style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
                    {s}
                  </span>
                </li>
              ))}
          ...
          >
            ...
            >
              {project.architecture?.erdImage ? (
                <img
                  src={project.architecture.erdImage}
                  alt="ERD"
                  style={{ width: "100%", borderRadius: "var(--radius-lg)" }}
                />
              ) : (
                <span
                  style={{ color: "var(--text-faint)", fontSize: "0.85rem" }}
                >
          ...
          {project.developmentStatus && (
            ...
            >
              <h4>Stato dello Sviluppo</h4>
              <p>
                <strong>Fase attuale:</strong>{" "}
                {project.developmentStatus.currentPhase}
              </p>
              <h5 style={{ marginTop: "12px", fontWeight: 600 }}>
                Prossimi passi tecnici:
              </h5>
              <ul>
                {project.developmentStatus.nextSteps.map((step, index) => (
                  <li
                    key={index}
                    style={{
                      fontSize: "0.9rem",
            ...
            >
              ...
              >
                {project.frontendIntegration.loginImage ? (
                  <img
                    src={project.frontendIntegration.loginImage}
                    alt="Login UI"
                    style={{ width: "100%", borderRadius: "var(--radius-lg)" }}
                  />
                ) : (
                  <span
                    style={{ color: "var(--text-faint)", fontSize: "0.85rem" }}
                  >
                    Login UI screenshot — coming soon
                  </span>
                )}
              </div>
              ...
              >
                ...
                <p style={{ fontSize: "0.9rem", lineHeight: 1.75 }}>
                  {project.frontendIntegration.description}
                </p>
                <ul
                  style={{
                    display: "flex",
